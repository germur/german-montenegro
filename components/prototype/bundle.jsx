...
function Sport3DIcon({ kind, size = 200 }) {
  ...
  React.useEffect(() => {
    ...
    } catch (err) { console.warn('WebGL not available for sport icon:', err); return; }
  ...
  const columns = [
    {
      ...
      links: [
        ...
        { label: 'Bursitis', page: 'bursitis' },
        { label: 'Contractura Muscular', page: 'contractura' },
        { label: 'Periostitis Tibial', page: 'periostitis' },
        { label: 'Epitrocleítis', page: 'epitrocleitis' },
